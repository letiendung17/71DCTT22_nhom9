                    ...
                    <div class="col-md-6">
                        <div class="product-dtl">
                            <div class="product-info">
                                ...
                                <div class="product-price-discount"><span>{{ number_format($product->GIA_SP, 0, ',', '.') }}₫</span></div>
                            </div>
                            ...
                            <div class="product-count">
                                ...
                                <form action="{{url('product/gio-hang')}}" method="POST" class="display-flex mb-3">
                                        @csrf

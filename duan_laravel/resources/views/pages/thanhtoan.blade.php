              ...
              @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="username" name="hovaten" placeholder="Nhập Đầy Đủ Họ Và Tên" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="email" id="email" placeholder="shopeedqc@gmail.com">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address"  name="diachi" placeholder="103/4c tổ 19,kp2 phương Đông Hưng Thuận....." required>
                        <div class="invalid-feedback">
...
{{-- 
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="number" class="form-control" name="sodienthoai" id="cc-expiration" placeholder="Nhập Số Điện Thoại" required>
                            <div class="invalid-feedback">

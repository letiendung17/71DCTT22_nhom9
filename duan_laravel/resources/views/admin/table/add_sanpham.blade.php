                    ...
                    <form role="form" action="{{ URL::TO('/admin/them-san-pham') }}" enctype="multipart/form-data"
                        ...
                        <section>
                            ...
                            <p style="color: #999999; font-size: 12px; display: block;" id="goiy">Có Thể Điều Chỉnh Sau
                                Khi Chọn Ngành Hàng lưu ý thông tin chi tiết chỉ xuất hiện khi có dữ liệu </p>
                        ...
                        <div class="form-group-inline text-center" style="display: inline; " id="giasp" >
                            ...
                            <table style="margin-bottom: 18px" >
                                ...
                                <tbody>
                                    <tr >
                                        <td>
                                            <input type="text" id="price" name="gia_sp" style="max-width: 100px; margin-right: 27px;"
                                            class="form-control" >
                                        </td>
                                        <td>
                                            <input type="number" min="1" id="sl" name="sl_sp" style="max-width: 86px;margin-right: 27px;"
                                            class="form-control">
                                    
                                        </td>
                                        <td>
                                            <input type="text" name="dvt" id="sl" style="max-width: 86px;margin-right: 47px;"
                                            class="form-control ">
                                        </td>
                                        <td>
                            ...
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-info ">Thêm Mới Sản Phẩm</button>
                            </div>    
